...
import computer from "./images/computer-monitor-svgrepo-com.svg";
import design from "./images/design-svgrepo-com.svg";
import communication from "./images/communication-between-users-svgrepo-com.svg";
import management from "./images/management-innovation-learn-svgrepo-com.svg";
  ...
  return (
    <div dir="rtl">
      <div className={homestyles.logoContainer}>
        <p className={homestyles.prag}>
          برا الصندوق : <br />
          هي حملة إعلامية بيقوم بيها مجموعة طلاب في قسم العلاقات العامة بكلية
          الإعلام جامعة الأزهر <br />
          هدف الحملة هو توعية الشباب بالمهارات الأساسية الي بنحتاجها في سوق
          العمل, وتوجيه الشباب لطرق إكتساب المهارات بدون تكاليف
        </p>
        <img src={logo} className={`w-25  ${homestyles.logo}`} />
      </div>
      <svg
        className={homestyles.wave}
      ...
      <div>
        <div class="row row-cols-1 row-cols-md-3 g-4 my-5 p-5">
          <h3 className="w-100 my-5 py-5">بعض المهارات التي يمكنك إكتسابها</h3>
          <Slider className="w-100 " {...settings}>
            <div class="col">
              <div class="card mx-3 p-2">
                <img
                  src={computer}
                  class="w-50 py-4 m-auto card-img-top"
                  alt="..."
                />
                <div class="card-body">
                  <h5 class="card-title">ICDL</h5>
                  <p class="card-text">
                    رخصة قيادة الحاسوب تعد أهم الأساسيات التي تحتاجها إليها بشكل
                    يومي سواء في العمل أو الدراسة, وهي مكونة من عدة برامج
                    مايكروسوفت أوفيس وأساسيات الحاسوب بشكل عام.
                  </p>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card mx-3 p-2">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    مهارات التواصل قد تبدو بسيطة إلا أنها من أهم المهارات
                    الأساسية اللتي تحتاج اليها في حياتك العملية, مهارات الكتابة
                    , الإلقاء, قدرة الشرح و توضيح الأفكار و بناء العلاقات
                    الصحية.
                  </p>
                </div>
              </div>
            ...
            <div class="col ">
              <div class="card mx-3 p-2">
                ...
                />
                <div class="card-body">
                  <h5 class="card-title">graghic Design</h5>
                  <p class="card-text">
                    تصميم الجرافيك أحد أهم المهارات المنتشرة و اللتي يوجد عليها
                    طلب في السوق بما في ذلك الإعلانات والملصقات والكتيبات
                    والشعارات والعلامات التجارية . . . إلخ
                  </p>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card mx-3 p-2">
                <img
                  src={management}
                  class="w-50 m-auto card-img-top"
                  alt="..."
                />
                <div class="card-body">
                  <h5 class="card-title">Management</h5>
                  <p class="card-text">
                    القيادة والإدارة مهارة مهمة في العمل و الحياة اليومية,
                    إمكانية ترتيب المهام توزيعها وإنجازها في الموعد بأفضل شكل
                    نعد قدرة مذهلة يمكن إكتسابها واللتي تظهرك كشخص يمكن الإعتماد
                    عليه.
                  </p>
                </div>
              </div>
